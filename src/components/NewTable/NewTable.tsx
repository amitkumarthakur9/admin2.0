...
import { Dimensions, Image, Platform, ScrollView, Text, TextInput, View } from "react-native"
import { Avatar, Button, Card, Checkbox, Chip, IconButton, MD3Colors, Searchbar } from "react-native-paper"
...
export const NewTable = () => {
    ...
    return (
        ...
        <ScrollView>
            <Card className='bg-white m-5 shadow-none' style={{ backgroundColor: "white", borderRadius: 5, borderColor: "transparent", shadowColor: "transparent" }}>
                ...
                <View className="m-4 w:full flex lg:flex-row flex justify-between text-white text-sm font-bold rounded-lg">
                    ...
                    <View className="flex lg:flex-row lg:items-center justify-center">
                        ...
                        <View className="rounded-md" style={{ height: 50, flexDirection: 'row', alignItems: 'center', borderWidth: 0.2 }}>
                            {/* <IconButton
                                icon="magnify"
                                iconColor={"black"}
                                size={20}
                            ...
                            <TextInput
                                ...
                                style={{ flex: 1, height: 40, borderColor: 'transparent', borderWidth: 0, color: "black", marginLeft: 10 }}
                            // {...rest}
                            />
                        </View>
                    </View>
                            ...
                            <View className="pr-5 pl-5 bg-white shadow sm:rounded-b-lg ">
                                {
                                    [...Array(10)].map((index, value) => {
                                        return (
                                            ...
                                            <View key={index} className={`hover:bg-slate-100 px-6 py-4`}>
