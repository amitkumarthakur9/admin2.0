...
export const FilterPopup = ({ open, removeFilter, clearFilters, filtersSchema, handleFilterChange, applyFilters, setFilterOpen, filterValues }) => {
    ...
    return <>
        {open && <View>
            <Box className="" width={width < 830 ? width : 550} ref={outsideClickRef} style={position}>
                <View style={{
