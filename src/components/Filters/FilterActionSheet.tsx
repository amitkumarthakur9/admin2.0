...
export const FilterActionSheet = ({ open, removeFilter, clearFilters, filtersSchema, handleFilterChange, applyFilters, setFilterOpen, filterValues }) => {
    ...
    return <Actionsheet isOpen={open} onClose={() => setFilterOpen(false)}>
        <Actionsheet.Content>
            <Box w="100%" justifyContent="center">
                <ScrollView automaticallyAdjustKeyboardInsets={true}>
                    ...
                    <View className='bg-[#000000] mb-2' style={{ borderRadius: 5 }}>
