    ...
    return (
        <View className="ml-1">
            <Menu
                ...
                onOpen={() => {
                    setSortingOpen(true), setFilterOpen(false);
                }}
                isOpen={sortingOpen}
                bgColor={"white"}
                placement="bottom"
                ...
                trigger={(triggerProps) => {
                    return (
                        ...
                        >
                            ...
                            {appliedSorting.key && appliedSorting.direction && (
                                <Badge
                                    height={5}
                                    width={5}
                                    colorScheme="danger"
                            ...
                            <View className="mr-2">
                                <Select
                                    ...
                                    onValueChange={(itemValue) =>
                                        handleSortingChange(itemValue, "key")
                                    }
                                >
