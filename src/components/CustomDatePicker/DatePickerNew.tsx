...
export default function DatePickerNew({ handleFilterChange, value, fromName = "From", toName = "To", showCalendar = false }) {
    ...
    return (
        <>
            <TouchableOpacity onPress={() => setOpen(true)} className="flex items-center justify-center flex-col rounded border-[0.2px] border-[#c7c7c7] px-4 py-3">
