...
const TableWrapper = ({ itemsPerPage = 10, totalItems, data, schema, apiUrl, reqData }) => {
    ...
    return (
        <View className='bg-white'>
            <View className='mt-4'>
                <DynamicComponentRenderer componentName={schema.component} data={data} schema={schema} />
            </View>
