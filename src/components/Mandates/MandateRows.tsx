    ...
    return <>
        <View className={`flex flex-row py-4 px-2 justify-between ` + (Dimensions.get("screen").width < 770 ? 'w-[1728px]' : '')}>
            ...
            <View className='flex flex-row items-center  w-[20%] justify-center'>
                <Text selectable className='font-semibold'>Bank Account</Text>
            </View>
            <View className='flex flex-row w-[20%] items-center justify-center'>
                <View className='flex flex-row items-center w-1/2'>
                    <Text selectable className='font-semibold'>Mandate Status</Text>
                </View>
            </View>
            <View className='flex flex-row items-center  w-[20%] justify-center'>
                ...
                return <View key={index}>
                    <View className={`flex flex-row p-2 justify-between `} >
                        ...
                        <View className='flex flex-row w-full w-[20%] flex-wrap'>
                            <View className='flex flex-row items-center w-full justify-between flex-wrap'>
                                <View className='flex flex-row items-center justify-start w-full flex-wrap'>
                                    <Pressable onPress={() => router.push(`/clients/${mandate.id}`)} className='flex flex-row rounded-full bg-[#e60202] mr-2 h-10 w-10 items-center justify-center flex-wrap'>
                                        <Text selectable className='text-white'>{getInitials(mandate.account.name)}</Text>
                                    </Pressable>
                                    <View className='flex flex-col flex-wrap w-9/12'>
                                        <View className='flex flex-row items-center text-black font-semibold flex-wrap w-11/12'>
                                            <Text selectable className='text-black font-semibold break-all'>{mandate.account.name}&nbsp;</Text>
                                            
                                        </View>
                                        <View className='flex flex-row items-center mt-0'>
                                            <Text selectable className='text-[#6C6A6A] text-sm'>{mandate.account.clientId}</Text>
                                        </View>
                                    </View>
                                </View>
                            </View>
                        ...
                        <View className='flex flex-row items-center w-[20%] justify-center flex-wrap'>
                            <View className='flex flex-row flex-wrap w-10/12 items-center justify-center'>
                                <View className='flex flex-col flex-wrap items-start w-11/12'>
                                    <Text selectable className='text-[#686868] font-semibold'>Bank Name: {mandate.bankAccount.bankName}</Text>
                                    <Text selectable className='text-[#686868] font-semibold'>Branch Name: {mandate.bankAccount.branchName}</Text>
                                    <Text selectable className='text-[#686868] font-semibold'>IFSC Code: {mandate.bankAccount.ifscCode}</Text>
                                </View>

                            </View>
                        </View>
                        <View className='flex flex-row  w-[20%] items-center justify-center'>
                            <Text selectable className='p-1 text-black text-end md:text-center text-xs'>{mandate.mandateStatus.name}&nbsp;</Text>
                        </View>
                        ...
                        <View className='flex flex-row items-center w-[20%] justify-center'>
                            ...
                            <Pressable
                                onPress={() => router.push(`mandates/${mandate.id}`)}
