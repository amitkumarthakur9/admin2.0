        ...
        switch (typeof ListItemSelectedIconComp) {
            ...
            default:
                return (
                    <Text
                        selectable
                        style={[{ ...styles.ITCMark, ...markedIconStyle }]}
                    >
                        ✓
                    </Text>
                );
                    ...
                    >
                        ...
                        >
                            ...
                            <Text
                                selectable
                                style={[
                                    { ...styles.ITCLabel, ...ListLabelStyle },
                                ]}
                            >
                                {label}
                            </Text>
                        </View>
                        {sData.includes(label) ? (
        ...
        return (
            <View>
                ...
                >
                    <View
                        style={[
                            { ...styles.DDPBadgeBelowPicker, ...ListStyle },
                        ]}
                    >
                        {sData.map((_) => (
                            <TouchableOpacity
                                        ...
                                        },
                                        {
                                            backgroundColor:
                                                badgeBackgroundColor[
                                                    Math.floor(
                                                        Math.random() *
                                                            badgeBackgroundColor.length
                                                    )
                                                ],
                                        },
                                    ]}
                                >
                                    <Text selectable style={styles.RSIBDot}>
                                        {"\u2B24"}
                                    </Text>
                                    <Text
                                        style={[
              ...
              <Text selectable style={styles.DDDPlus}>{PLUS}</Text>
                    ...
                    >
                        ...
                        <View style={styles.DDPressable}>
                            {dropdownIndicator == "arrow" ? (
                                <Text selectable style={styles.DDDArrow}>
                                    {DOWN_ARROW}
                                </Text>
                            ) : (
                                <Text selectable style={styles.DDDPlus}>
                                    {PLUS}
                                </Text>
                            )}
                        </View>
