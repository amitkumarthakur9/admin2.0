            ...
            <View className="bg-white">
                <View className="p-2">
                    ...
                    <View className="" style={{}}>
                        <TextInput
                            ...
                            placeholder={
                                "Search Name/Email/Mobile/ClientID/FE User ID/PAN No"
                            }
                ...
                <View className="mt-4">
                    {[...Array(8)].map((index, value) => {
                        return (
                            <View
                                className={`flex flex-row p-2 justify-between flex-wrap ${value % 2 != 0 ? "bg-[#EFEFEF]" : ""}`}
                            >
                  ...
                  <Checkbox status='unchecked' />
                                        ...
                                        <View className="flex flex-row items-center justify-start w-10/12 lg:w-full">
                                            ...
                                            <View className="flex flex-col">
                                                <Text
                                                    selectable
                                                    className="text-black font-semibold max-w-[200px] lg:max-w-[300px] break-all"
                                                >
                                                    KASHINATH NARAYAN MORE
                                                    {value == 1 &&
                                                        "scadadddaacdacadcdc cddscdscd"}
                                                </Text>
                                    ...
                                    <View className="pl-12 flex flex-row items-center w-full lg:w-7/12 justify-between md:justify-between lg:justify-between mt-2 md:mt-2 lg:mt-0">
                                        <View className="flex flex-col w-5/12 items-start lg:items-center">
                                            <Text
                                                selectable
                                                className="text-black font-semibold max-w-[200px] break-all text-left"
                                            >
                                                AXIS MUTUAL FUND
                                            </Text>
                                        ...
                                        <View className="flex flex-col w-5/12 justify-end items-end lg:items-center">
                                            <Text
                                                selectable
                                                className="text-black font-semibold max-w-[200px] break-all"
