          ...
          <View key={index}>
            ...
            >
                        ...
                        >
                          ...
                          <Popover.Body>
                            <View>
                              ...
                              <Text>
                                PAN Number: {rta.account.user[0].panNumber}
                              </Text>
                            </View>
                          </Popover.Body>
                        </Popover.Content>
              ...
              <View className="flex flex-row w-1/12">
                <Text className="w-10/12" selectable>
                  {rta.paymentDate
                    ? moment(rta.paymentDate).format("DD-MM-YYYY hh:mm:ss A")
                    : "-"}
                </Text>
              </View>
              <View className="flex flex-row w-1/12">
              ...
              <View className="flex flex-row w-1/12">
                <Text className="w-10/12" selectable>
                  {rta.createdAt
                    ? moment(new Date(rta.createdAt)).format(
                    ...
                    <Pressable
                      onPress={() => {
                        setModalVisible(true),
                          setId(rta.id),
                          setTransactionStatus(rta.transactionStatus);
                      }}
                    >
              ...
              <View className="flex flex-row w-1/12 justify-start">
                <Pressable
                  onPress={() => router.push(`rta-reconciliation/${rta.id}`)}
