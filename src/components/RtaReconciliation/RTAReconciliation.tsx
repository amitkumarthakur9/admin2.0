...
const RTAReconciliation = () => {
    ...
    const [params, setParams] = useState(useLocalSearchParams<{ holdingId?: string }>());
            ...
            <View className='border-[0.2px]  border-[#e4e4e4]'>
...

                {
                    !isLoading ? <View className={'mt-4 z-[-1] '}>
                        {width < 830 ? <Cards data={data} schema={null} getDataList={getDataList} /> : <RTAReconciliationRows getDataList={getDataList} data={data} schema={filtersSchema} />}
