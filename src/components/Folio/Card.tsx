                        ...
                        >
                            <View className="flex flex-col w-full">
                                <View className="flex flex-row items-center w-full justify-between">
                                    ...
                                    <View className='flex flex-row items-center w-full justify-center'>
                                        <Text selectable className='p-1 text-black font-bold text-end text-sm'>Units: {order.units} </Text>
                                    </View>
                                    <View className='flex flex-row items-center w-full justify-center'>
                                        <Text selectable className='p-1 text-black font-bold text-end text-sm'>Invested Value: {order.investedValue ? (RupeeSymbol + order.investedValue) : '-'} </Text>
                                    </View>
                                    <View className='flex flex-row items-center w-full justify-center'>
                                        <Text selectable className='p-1 text-black font-bold text-end text-sm'>Curr Val: {RupeeSymbol + order.currentValue} </Text>
                                    </View>
                                ...
                                <View className='flex flex-row'>
                                    <Text selectable className='text-black text-xs text-center'>{moment(new Date(order.createdAt)).format("DD-MM-YYYY hh:mm:ss A")}</Text>
                                </View>
                            </View> */}
