...
import { AccountShadowPhone, BorderShadow, BorderShadowPhone } from "../../../../../src/components/Styles/Shadow";
                    ...
                    <View className=''>
                        <View className='flex flex-row justify-between items-center mb-[30px] mt-3 bg-[#eaf3fe] h-28 px-2 '>
                            <View className='flex flex-col w-6/12'>
                                <Text selectable className='text-2xl font-extrabold mb-3'>Holdings</Text>
                        ...
                        <View className='flex flex-row items-center p-2'>
                            <View className='flex flex-col '>
                                <View className='flex flex-row rounded-full bg-[#e60202] mr-2 h-10 w-10 items-center justify-center'>
                                    <Text selectable className='text-white text-center'>{getInitials(data.name)}</Text>
                                </View>
                            </View>
                            <View className='flex flex-col ml-1'>
                                <Text selectable className='font-bold text-base'>{data.name}</Text>
                                <View className='flex flex-row items-center'>
                                    <Text selectable className=' text-xs'>{data.clientId}</Text>
                                    <View className='mx-2'>
                                        <Icon name="circle" style={{ fontWeight: "100" }} size={8} color="grey" />
                                    </View>
                                    <Text selectable className=' text-xs'>{data.users[0].panNumber}</Text>
                                </View>
