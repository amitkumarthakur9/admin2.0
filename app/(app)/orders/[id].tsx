...
export default function OrderDetail() {
    ...
    useEffect(() => {
        ...
        async function getOrderDetails() {
            const response: OrderDataInterface = await RemoteApi.get(
                `order/${id}`
            );
            if (response) {
                    ...
                    <View className="bg-white">
                        ...
                        <View>
                            ...
                            >
                                    ...
                                    <View className="flex flex-row items-center w-full flex-wrap ">
                                        ...
                                        >
                                            ...
                                            >
                                                <Text
                                                    selectable
                                                    className="text-black font-semibold break-all text-sm flex-wrap w-[90%]"
                                                >
                                    ...
                                    <View className="flex flex-row items-center w-full flex-wrap mt-4 p-3">
                                        {data.orderType.name == "SIP" ? (
                                            <>
                                                <View
                                                    className={
                                                        "flex flex-row items-center w-4/12 lg:w-3/12 justify-start lg:justify-start mb-[30px]"
                                                    }
                                                >
                                                    <View className="flex flex-col">
                                                        <Text
                                ...
                                <View
                                    className="flex flex-col w-full rounded-b"
                                    style={{
